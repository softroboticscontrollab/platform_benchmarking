function [a, b] = soft_generate_constraints_sym()
...
% barrierB_sym
barrierB_sym_filename = "soft_barrierB_" + barriername + "_sym.mat";
...
constraints_func_filename = "soft_constraints_" + barriername;
constraints_sym_filename = "soft_constraints_" + barriername + "_sym.mat";
...
matlabFunction(a, "File", constraints_func_filename_a, 'vars', {x, l1, l2, m2, m6, k1, k2, damping, aE, bE, gam, k_env, F_max, g});
matlabFunction(b, "File", constraints_func_filename_b, 'vars', {x, l1, l2, m2, m6, k1, k2, damping, aE, bE, gam, k_env, F_max, g});

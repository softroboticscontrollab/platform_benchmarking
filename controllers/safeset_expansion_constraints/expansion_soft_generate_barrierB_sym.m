function barrierB_sym = expansion_soft_generate_barrierB_sym()
...
barrier = h_prime(1,:) - H_prime(1,:) * r ;
% barrier = h_prime(2,:) - H_prime(2,:) * r ;
% barrier = h_prime(3,:) - H_prime(3,:) * r ;
...
barrierB_sym = barrierB_hsu2015(barrier, hdot, aE, bE);
...
barrierB_func_filename = "expansion_soft_barrierB_" + barriername;
...
matlabFunction(barrierB_sym, "File", barrierB_func_filename, 'vars', {x, l1, l2 aE, bE});

...
ezloopdata_safetyplotter(smooth_q_cells, time_cells, time_TnR4, smooth_q_TnR4, false)
...
ezloopdata_safetyplotter(smooth_q_cells, time_cells, time_TnR4, smooth_q_TnR4, true, rho_cells)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
% dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-26_CD4FP1.csv'; 
% [time_tra5, q_tra5, dq_tra5, ddq_tra5, smooth_q_tra5, smooth_dq_tra5, smooth_ddq_tra5,~,rho_tra5] = ezloopdata_compare(dat, false, false, true, calib_start);
% 
...
% rho_cells = {rho_tra5};
% 
% ezloopdata_safetyplotter(smooth_q_cells, time_cells, time_cal, smooth_q_cal, true, rho_cells)

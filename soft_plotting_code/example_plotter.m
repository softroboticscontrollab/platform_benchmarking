...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-23_TnR3.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CD1.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CD2.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CD3.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CD4.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CD5.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_CD2FP1.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_CD2FP2.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_CD2FP3.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_CD2FP4.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_CD2FP5.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CBFH1.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CBFH2.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CBFH3.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CBFH4.csv'; 
...
dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_TnR3CBFH5.csv'; 
...
smooth_q_cells = {smooth_q_tra5};

time_cells = {time_tra5};
...
% dat = 'manuscript_data/ezloophw_closedloop_ros2_reserv_pneumatics_2026-3-25_CalibrationRunV1.csv';
% [time_cal, q_cal, dq_cal, ddq_cal, smooth_q_cal, smooth_dq_cal, smooth_ddq_cal, calib_start,~] = ezloopdata_compare(dat, false, false, true, 0);
% q0_NONET1 = smooth_q_cal(:,1);
% q1_NONET1 = smooth_q_cal(:,2);
% x_cal = l2 * ((cos(q0_NONET1) .* sin(q1_NONET1) + sin(q0_NONET1) .* cos(q1_NONET1) - sin(q0_NONET1)) ./ q1_NONET1) ...
%     + l1 * (sin(q0_NONET1) ./ q0_NONET1);
% y_cal = l2 * ((sin(q0_NONET1) .* sin(q1_NONET1) - cos(q0_NONET1) .* cos(q1_NONET1) + cos(q0_NONET1)) ./ q1_NONET1) ...
%     + l1 * ((1 - cos(q0_NONET1)) ./ q0_NONET1);
% 
% y_line = -0.364077*x_cal+0.159627;
% tol = 1e-3;
% idx = find(abs(y_cal - y_line) < tol);
% % 
% % if isempty(idx)
% % 
% % else
% %     print(smooth_q_cal(idx))
% % end
% 
% plot(x_cal,y_cal); hold on
% plot(x_cal,y_line); hold off
% % ylim([0.15 0.245])
% % xlim([-0.15 0.15])
% 
% matching_points = [x_cal(idx) y_cal(idx)];
% % disp(matching_points)
% 
% dataset = [[time_cal(idx(1)),0]; smooth_q_cal(idx(1),:); smooth_dq_cal(idx(1),:); smooth_ddq_cal(idx(1),:)];
% disp(dataset)